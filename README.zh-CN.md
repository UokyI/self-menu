...
图像徽章:[![Version](https://img.shields.io/badge/version-0.0.3-blue)](https://github.com/UokyI/self-sub-menu)

[English](README.md) | **简体中文**

## 功能特性

- 在编辑器与资源管理器的右键菜单中加入 **Self Sub Menu** 子菜单
...
1. 安装扩展。
2. 在编辑器或资源管理器中任意位置右键，选择 **Self Sub Menu ▶ Self Sub Menu: 配置菜单项**。
3. 添加菜单项并点击 **保存**。
